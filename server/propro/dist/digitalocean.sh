...
# /_/              /_/
#
# Built from: digitalocean.propro
...
#!/usr/bin/env bash
# requires app.sh
APP_RVM_RUBY_VERSION="2.1.1" # @specify
...
# Options from: digitalocean.propro
SYSTEM_SHMALL_PERCENT="0.65"
SYSTEM_SHMMAX_PERCENT="0.5"
SYSTEM_LOCALE="en_US.UTF-8"
SYSTEM_TIMEZONE="Etc/UTC"
VPS_SYSTEM_HOSTNAME="uploader"
VPS_SYSTEM_FQDN="uploader.unspace.ca"
VPS_SYSTEM_ADMIN_AUTHORIZED_GITHUB_USERS="ghedamat heycarsten minusfive"
VPS_SYSTEM_ADMIN_SUDO_PASSWORD=""
VPS_SYSTEM_ADMIN_USER="admin"
VPS_SYSTEM_PUBLIC_NETMASK="255.255.240.0"
VPS_SYSTEM_PRIVATE_NETMASK="255.255.0.0"
NGINX_VERSION="1.6.0"
NGINX_CONFIGURE_OPTS="--with-http_ssl_module --with-http_gzip_static_module"
NGINX_CLIENT_MAX_BODY_SIZE="5m"
NGINX_WORKER_CONNECTIONS="1000"
REDIS_VERSION="2.8.9"
APP_DOMAIN="uploader.unspace.ca"
APP_AUTHORIZED_GITHUB_USERS="ghedamat heycarsten minusfive"
APP_USER="deploy"
APPS_DIR="/sites"
APP_ENV="production"
APP_RVM_RUBY_VERSION="2.1.2"
APP_SIDEKIQ_CONFIG_FILE_NAME="sidekiq.yml"
...
PG_VERSION="9.3"
PG_EXTENSIONS="btree_gin btree_gist fuzzystrmatch hstore intarray ltree pg_trgm tsearch2 unaccent"
DB_PG_NAME="uploader"
DB_PG_USER="deploy"
EXTRA_PACKAGES="git-core libxslt-dev libxml2-dev imagemagick libmagickwand-dev"
